      ...
      <div id="Menu" className=" bg-[#27AE60] mt-5 px-4">
        ...
        <div className="flex flex-col gap-3 px-3 md:flex-row md:justify-between md:px-7 md:items-center">
          <div className="flex flex-col gap-1">
            <h1 className="text-xl font-semibold">Hi, Im <br /> Elechi Paschal</h1>
        ...
        <div className="text-center md:mx-24" id="about">
          ...
          <p className="mt-4 text-sm">Am Paschal and am from Nigeria. Am a full stack Developer 
            ...
            at an affortable price. contact us now form deals.
          </p>
        </div>
        ...
        <div className="mt-6" id="skills">
          ...
          <div className="bg-[#212121] mx-2 grid grid-cols-3 gap-5 py-4 px-2 mt-8">
            ...
            <div>
              <h3 className="text-3xl font-bold text-center text-gray-600">65%</h3>
            ...
            <div>
              <h3 className="text-3xl font-bold text-center text-gray-600">20%</h3>
            ...
            <div>
              ...
              <p className="text-xs text-center text-[#27AE60] font-medium">Nuxt js</p>
            </div>
          </div>
        </div>
